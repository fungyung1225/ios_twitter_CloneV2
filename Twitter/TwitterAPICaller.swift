...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func postTweet(tweetString: String, success: @escaping()->(),faliure: @escaping(Error)->()){
    ...
    func favoriteTweet(tweetId: Int, success: @escaping()->(),faliure: @escaping(Error)->()){
    ...
    func unfavoriteTweet(tweetId: Int, success: @escaping()->(),faliure: @escaping(Error)->()){
    ...
    func retweet(tweetId: Int, success: @escaping()->(),faliure: @escaping(Error)->()){
